...
class FlussAdmin:
    async def create_database(self, database_name: str, ignore_if_exists: bool = False) -> None: ...
    async def drop_database(self, database_name: str, ignore_if_not_exists: bool = False) -> None: ...
    ...
    async def drop_table(self, table_path: TablePath, ignore_if_not_exists: bool = False) -> None: ...
...
class LogScanner:
    def subscribe(self, snapshot_id: Optional[int], start_offset: Optional[int]) -> None: ...
